...
public class AjCaptchaServiceAutoConfiguration {
    ...
    public CaptchaService captchaService(AjCaptchaProperties prop) {
        ...
        if ((StringUtils.hasLength(prop.getJigsaw()) && prop.getJigsaw().startsWith("classpath:"))
                || (StringUtils.hasLength(prop.getPicClick()) && prop.getPicClick().startsWith("classpath:"))) {
